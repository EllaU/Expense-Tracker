   ...
   <div class="container">
     <div class="row mb-3 " style="justify-content: center;align-items: center;">
       <div class="col-lg-10" style="flex-direction: row;">
        <h3  id="categories" style="color: black;">Expenses</h3 >
     ...
     <div class="row" style="justify-content: center;align-items: center;">
       <div class="col-lg-10">
        <div class="">
          <div class="">
            <div class="container table table-bordered scroll"  style="border-width: 2;border-color: black;">
              <div class="row mt-3">
